...
{
    class HttpStatusObjects
    {
        internal static HttpStatusObjects.Performance HttpStatusLastPerformance { get; set; }
        internal static HttpStatusObjects.Beatmap HttpStatusLastBeatmap { get; set; }

        internal static HttpStatusObjects.Performance HttpStatusCurrentPerformance { get; set; }
        internal static HttpStatusObjects.Beatmap HttpStatusCurrentBeatmap { get; set; }

        internal static bool FinishedLastSong = false;
        internal static bool FailedLastSong = false;

        internal static bool FinishedCurrentSong = false;
        internal static bool FailedCurrentSong = false;
