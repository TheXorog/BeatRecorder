...
internal class SharedStatus
{
    ...
    public void Update(SharedStatus newStatus)
    {
        ...
        GameInfo.ModVersion = newStatus.GameInfo.ModVersion;
        GameInfo.GameVersion = newStatus.GameInfo.GameVersion;

        BeatmapInfo.Name = newStatus.BeatmapInfo.Name;
        BeatmapInfo.SubName = newStatus.BeatmapInfo.SubName;
        BeatmapInfo.Author = newStatus.BeatmapInfo.Author;
        BeatmapInfo.Creator = newStatus.BeatmapInfo.Creator;
        BeatmapInfo.Cover = newStatus.BeatmapInfo.Cover;
        BeatmapInfo.Bpm = newStatus.BeatmapInfo.Bpm;
        BeatmapInfo.NoteJumpSpeed = newStatus.BeatmapInfo.NoteJumpSpeed;
        BeatmapInfo.Difficulty = newStatus.BeatmapInfo.Difficulty;
        BeatmapInfo.NoteCount = newStatus.BeatmapInfo.NoteCount;
        BeatmapInfo.BombCount = newStatus.BeatmapInfo.BombCount;
        BeatmapInfo.WallCount = newStatus.BeatmapInfo.WallCount;
        BeatmapInfo.CustomDifficulty = newStatus.BeatmapInfo.CustomDifficulty;

        PerformanceInfo.RawScore = newStatus.PerformanceInfo.RawScore;
        PerformanceInfo.Score = newStatus.PerformanceInfo.Score;
        PerformanceInfo.Accuracy = newStatus.PerformanceInfo.Accuracy;
        PerformanceInfo.Rank = newStatus.PerformanceInfo.Rank;
        PerformanceInfo.MissedNoteCount = newStatus.PerformanceInfo.MissedNoteCount;
        PerformanceInfo.BadCutCount = newStatus.PerformanceInfo.BadCutCount;
        PerformanceInfo.BombHitCount = newStatus.PerformanceInfo.BombHitCount;
        PerformanceInfo.MaxCombo = newStatus.PerformanceInfo.MaxCombo;
        PerformanceInfo.SoftFailed = newStatus.PerformanceInfo.SoftFailed;
        PerformanceInfo.Failed = newStatus.PerformanceInfo.Failed;
        PerformanceInfo.Finished = newStatus.PerformanceInfo.Finished;
    }
