...
class HttpStatusStatus
{
    ...
    internal static HttpStatusStatus.Performance HttpStatusCurrentPerformance { get; set; }
    internal static HttpStatusStatus.Beatmap HttpStatusCurrentBeatmap { get; set; }
